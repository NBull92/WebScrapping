...
When the user clicks the button, the associated article will be loaded in their defualt web browser. In the futrue I would look into creating a new view within the app to showcase the news article itself.
